...
Emits behaviorscope-n-v1 NPZs compatible with data_y.py / train_y.py.

Usage (Windows, IntegraPose conda env):
    python fly_to_behaviorscope_npz_full.py ^
        --aggression_root E:\\BehaviorScope-N\\Fly_v_Fly_2021\\Aggression\\Aggression ^
        --yolo_weights E:\\path\\to\\fly_yolo_pose.pt ^
        --output_root E:\\BehaviorScope-N\\Fly_v_Fly_2021\\fly_behaviorscope_npz ^
