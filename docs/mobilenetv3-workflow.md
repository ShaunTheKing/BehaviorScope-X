...
Use this workflow when you have a licensed MobileNetV3 pose checkpoint and source videos that you are allowed to process. Manuscript-scale evaluation should use the full recorded runs and provenance tables from the reproducibility package.
