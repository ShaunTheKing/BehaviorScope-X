...
Designed to be called once per source frame from `infer_x.py`. The frame is
...
try:
    from cropping_x import NCropDetection
except Exception:  # pragma: no cover
    from .cropping_x import NCropDetection  # type: ignore
