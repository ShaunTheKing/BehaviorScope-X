"""
Keypoint-agnostic relational pose features for BehaviorScope-N.
...
pose model (MARS top-view's 7 keypoints, MARS front-view, DeepLabCut
configurations of any K, SLEAP outputs, etc.) without configuration.
