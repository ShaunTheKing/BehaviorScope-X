...
This wrapper is intentionally independent of run_controlled_comparison_suite.py
so it cannot expand into the old Fly full matrix. It runs only the adaptation
experiment needed for the manuscript:
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Run the focused Fly-v-Fly adaptation rerun without the old full matrix.",
